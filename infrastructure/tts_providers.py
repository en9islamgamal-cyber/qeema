"""
infrastructure/tts_providers.py — VALUE / QEEMA v15.0
=====================================================================
[Changes v15]
- ElevenLabsProvider: added `speed` param (default 0.85 — slower & clearer for children)
- Default stability raised 0.50→0.68 (consistent grandfather voice)
- Default similarity raised 0.85→0.88 (tighter voice clone)
- Default style lowered 0.50→0.30 (calmer, less theatrical)
- Arabic comma ،  no longer converted to ASCII , (ElevenLabs handles Arabic natively)
"""
