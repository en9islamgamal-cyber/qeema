"""
infrastructure/ffmpeg_assembler.py — VALUE / QEEMA v22.5 — production video assembler
========================================================================
...
class FFmpegAssembler(VideoAssembler):
    ...
    def encode_segment(
        ...
        video_filter: Optional[str] = None,  # v17: color grade inline
    ) -> str:
