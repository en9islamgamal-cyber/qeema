...
class PipelineConfig:
    ...
    # speed=0.95: slightly slower for kids 6-10 (clarity)
    ...
    logo_overlay_width: int = 180  # px on 1920×1080 canvas
    logo_overlay_position: str = "bottom_right"  # bottom_right | top_right
    logo_overlay_opacity: float = 0.75
    logo_overlay_margin: int = 30  # px from edges
    # Larger logo for the intro splash (first 2 seconds)
    logo_intro_width: int = 420
    logo_intro_duration_sec: float = 2.0
