"""
core/pipeline_strategy.py — VALUE / QEEMA v21 (NEW)
=========================================================================
...
PipelineStrategy is computed ONCE at the start of an episode based on:
  - Current quota state (ElevenLabs chars, Leonardo tokens, Anthropic $)
...
Tafsir validation         claude  claude    heuristic only
...
class PipelineStrategy:
    ...
    # Tafsir validation
    use_batched_tafsir: bool         # 1 Claude call vs N
    use_claude_tafsir: bool          # vs heuristic-only
    ...
    def summary(self) -> str:
        ...
        return (
            ...
            f"batched_tafsir={self.use_batched_tafsir}, "
    ...
    def detailed_report(self) -> str:
        ...
        lines = [
            ...
            f"│ Batched tafsir:     {self._yn(self.use_batched_tafsir)}",
            f"│ Claude tafsir:      {self._yn(self.use_claude_tafsir)}",
...
class StrategyFactory:
    ...
    def _build_for_mode(
        ...
        # Tafsir: HIGH/BALANCED use Claude (batched). ECONOMY uses heuristic.
        use_claude_tafsir = mode != QualityMode.ECONOMY and has_anthropic_key
        use_batched_tafsir = use_claude_tafsir  # batched only makes sense w/ Claude
        ...
        return PipelineStrategy(
            ...
            use_batched_tafsir=use_batched_tafsir,
            use_claude_tafsir=use_claude_tafsir,
