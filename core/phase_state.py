...
class PhaseState:
    ...
    # v22.6.3: asset_paths now also carries _deep_visuals (list of dicts)
    # and _tts_directions (dict of dicts), in addition to the original
    # audio_map / mastered_map / image paths. The widened Any type reflects
    # what we actually store — JSON survives the round-trip regardless.
    asset_paths: Dict[str, Any] = field(default_factory=dict)  # Phase 2
