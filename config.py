...
# ═══════════════════════════════════════════════════════
# VOICE — Google AI Studio (Gemini TTS)
# ═══════════════════════════════════════════════════════
class VoiceConfig:
    # نموذج Gemini للصوت
    ...
    NARRATOR_VOICE = "Charon"     # ذكر، عميق، رزين

    # صوت بديل عند TTS للأطفال
    CHILD_VOICE = "Puck"          # شاب خفيف

    # إعدادات الصوت الخام (Gemini output)
    ...
    # مسارات الصوت القرآني (everyayah.com CDN)
    ...
    # الراوي الافتراضي (الشيخ المنشاوي — أنسب للأطفال)
    DEFAULT_RECITER = "alafasy"


# ═══════════════════════════════════════════════════════
# SUBTITLES — تصميم الترجمة على الشاشة
# ═══════════════════════════════════════════════════════
class SubtitleConfig:
    # الخط
    FONT_SIZE_LARGE  = 80    # الآيات القرآنية
    FONT_SIZE_MEDIUM = 60    # كلام الراوي
    FONT_SIZE_SMALL  = 42    # ملاحظات

    # الألوان
    COLOR_AYAH      = "white"
    COLOR_NARRATOR  = "white"
    COLOR_HIGHLIGHT = "#FFD700"   # ذهبي للتمييز
    ...
    # موضع السبتايتل (من الأسفل)
    MARGIN_BOTTOM_H  = 120   # horizontal
    MARGIN_BOTTOM_V  = 200   # vertical (Shorts)
...
class VisualConfig:
    ...
    # الإعدادات
    WIDTH  = 1440
    HEIGHT = 1440    # مربع يناسب كلا الشكلين
    GUIDANCE_SCALE = 7
    STEPS = 35
    NUM_IMAGES = 1
...
# ═══════════════════════════════════════════════════════
# CURRICULUM — المنهج الدراسي (السور وترتيبها)
# ═══════════════════════════════════════════════════════
