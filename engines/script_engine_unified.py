...
class UnifiedScriptEngine:
    ...
    def _build_episode_script(
        ...
        *,
        ...
        for i, (ayah, scene_data) in enumerate(zip(ayahs, scene_data_list)):
            ...
            # Build full visual prompt
            visual_prompt = self._build_visual_prompt(scene_data)
    ...
    @staticmethod
    def _build_visual_prompt(scene_data: Dict[str, Any]) -> str:
        """Combine subject + action + environment into visual prompt."""
