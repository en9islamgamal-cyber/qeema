...
{{
  ...
  "visual_prompt": "Cinematic scene description in English. NO human figures speaking. Focus on: nature, cosmos, abstract concepts, symbolic imagery. Style suffix MANDATORY: ', warm 2D children illustration, soft pastel colors, golden lighting, no text in image, ages 6-12'",
...
class ScriptEngine:
    ...
    PROMPT_VERSION: str = "v16.0"  # bump invalidates cached scripts
