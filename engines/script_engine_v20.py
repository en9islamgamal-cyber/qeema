"""
engines/script_engine_v20.py — VALUE / QEEMA v22.1 (UPGRADED)
=========================================================================
...
- Be specific: "ant carrying leaf 100x its weight on bark texture"
                ليس "an ant"
- Atmospheric: include time-of-day, weather, mood lighting
- No human faces, no famous characters, no text in image
- Studio Ghibli inspired hand-painted style (auto-applied later)
