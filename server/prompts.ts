...
- intro: ابدأ بهذه الروح بالظبط: "سفينة قيمة هتاخدنا النهارده في رحلة نفهم فيها معاني
  آيات سورة ${surah.surahName}، يلا بينا نسمع الآيات وبعدين نفهمها واحدة واحدة في طريق رحلتنا."
  (دافي ومشوّق، وممكن تزوّد عليها جملة ترحيب صغيرة.)
