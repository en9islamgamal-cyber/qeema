...
- intro: ده الجزء **المتغيّر** من المقدمة اللي بييجي بعد انترو ثابت بينتهي بكلمة "سورة".
  فابدأ مباشرةً باسم السورة وكمّل بهذه الروح: "${surah.surahName}! ... يلا بينا نسمع
  الآيات الأول، وبعدين نفهمها واحدة واحدة في طريق رحلتنا." (جملة قصيرة مشوّقة، من غير
  ما تعيد الترحيب أو تذكر اسم القناة — دول في الانترو الثابت.)
