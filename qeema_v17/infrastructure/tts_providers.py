"""
infrastructure/tts_providers.py — VALUE / QEEMA v16.0
=====================================================================
[v16 changes]
- Adaptive voice: per-emotion stability/style/speed overrides
- Safe SSML extraction: keeps only <break> tags (eleven_multilingual_v2 compatible)
- Optional `emotion` parameter on synthesize() for per-call tuning
- All tier-0 limits removed (assumes paid Starter+ plan)

[v15 changes kept]
- speed=0.85 default
- Stability 0.68, similarity 0.88, style 0.30 defaults
- Arabic comma preserved
"""
...
# ════════════════════════════════════════════════════════════════
# v16 — Adaptive voice settings per scene emotion
# ════════════════════════════════════════════════════════════════
EMOTION_VOICE_OVERRIDES: Dict[str, Dict[str, float]] = {
    "warm": {
        # Default — explanatory passages
        "stability": 0.68, "style": 0.30, "speed": 0.85,
    },
    "playful": {
        # For hooks and engaging analogies — more expressive
        "stability": 0.55, "style": 0.45, "speed": 0.92,
    },
    "reverent": {
        # For Quranic recitation context — slowest, calmest
        "stability": 0.85, "style": 0.15, "speed": 0.78,
    },
    "peaceful": {
        # For takeaways and reflective moments
        "stability": 0.78, "style": 0.20, "speed": 0.82,
    },
    "excited": {
        # For intro hooks and curiosity-gap statements
        "stability": 0.50, "style": 0.50, "speed": 0.95,
    },
}
